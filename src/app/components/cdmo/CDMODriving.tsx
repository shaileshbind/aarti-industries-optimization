      ...
      <div className='lg:absolute bottom-9 lg:px-14 mb-0 lg:mb-24 z-10 w-full flex lg:flex-row flex-col justify-between'>
        <div className='w-full lg:w-[50%] bg-white rounded-3xl overflow-hidden'>
          ...
          <div className='lg:pt-[40px] lg:pb-[70px] pt-7'>
            <H2 className='lg:w-[85%] w-full pb-6 px-[20px] lg:px-[42px]'>
              Driving Innovation Through R&D Excellence
            </H2>
            <BodyText1 className='pb-7 px-[20px] lg:px-[42px]'>
              Our Research and Technology Centre (ARTC) in Navi Mumbai and Vapi combines
              world-class facilities with 250+ scientists, under one roof, enabling us to
              broaden our scope from process optimisation to end-to-end new product development,
              scaling up new molecules and chemistries across diverse industries.
            </BodyText1>

            <div className={`hidden lg:block absolute bottom-0 lg:w-[46.40%] w-full transition-all duration-700 bg-gradient-orange-3 ${isOpen ? 'rounded-2xl' : 'rounded-b-3xl'
              }`}>
              ...
              >
                ...
                <span className={`text-white text-3xl font-light transition-transform duration-300 ${isOpen ? 'rotate-45' : ''}`}>
                  +
                </span>
              </button>
          ...
          <div className={`block lg:hidden mx-3 w-auto transition-all duration-700 bg-gradient-orange-3 rounded-2xl mb-9`}>
              {/* Accordion Header - Always Visible */}
              <button
                onClick={toggleAccordion}
        ...
        <div className='w-full lg:w-[45%] flex justify-center items-center flex-wrap gap-6'>
          <div className="bg-grey-100 py-[27px] px-[24px] rounded-[20px] stat-box h-[150px] w-[164px] lg:h-[185px] lg:w-[246px]">
            ...
            <BodyText2 className='lg:w-[80%] w-full'>Products in R&D Pipelines</BodyText2>
          </div>
          <div className="bg-grey-100 py-[27px] px-[24px] rounded-[20px] stat-box h-[150px] w-[164px] lg:h-[185px] lg:w-[246px]">
            <H2 className="text-orange-200">40+</H2>
            <BodyText2 className='lg:w-[80%] w-full'>years of special</BodyText2>
          </div>
          <div className="bg-grey-100 py-[27px] px-[24px] rounded-[20px] stat-box h-[150px] w-[164px] lg:h-[185px] lg:w-[246px]">
            <H2 className="text-orange-200">40+</H2>
          ...
          <div className="bg-grey-100 py-[27px] px-[24px] rounded-[20px] stat-box h-[150px] w-[164px] lg:h-[185px] lg:w-[246px]">
            <H2 className="text-orange-200">40+</H2>
            <BodyText2 className='lg:w-[80%] w-full'>years of expertise</BodyText2>
          </div>
        </div>
      </div>
    </section>
