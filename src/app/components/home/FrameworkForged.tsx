...
const FrameworkForged = () => {
  ...
  return (
    <div>
      <H2 className="block lg:hidden mb-[24px] text-blue-200 ">
        Framework Forged in Science, Strategy, and Scale
      </H2>
      <div className="relative w-full grid grid-cols-1 lg:grid-cols-[55%_45%]">
        <div className="lg:ml-[5rem] order-2 lg:order-1">
          <H2 className="hidden lg:block text-blue-200 max-w-[460px]">
            Framework Forged in Science, Strategy, and Scale
          </H2>
          <div className="mt-[65px] mb-[27px] flex justify-between max-w-[unset] lg:max-w-[440px]">
                ...
                return (
                  <SwiperSlide
                    ...
                    className={`transition-all duration-500  ${
                      index === activeIndex ? "" : "blur-xs opacity-50"
                    }`}
                  >
        ...
        <div className="order-1 lg:order-2 relative h-[317px] lg:h-[640px] w-full overflow-hidden">
          ...
          >
            ...
            <Image
              ...
              width={500}
              height={548}
              className="absolute object-cover rounded-l-[20px] lg:rounded-l-[30px]  h-[calc(100%-71px)] lg:h-[calc(100%-93px)] w-[calc(100%-71px)] lg:w-[calc(100%-210px)]"
            />
