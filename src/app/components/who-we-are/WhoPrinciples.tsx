...
const WhoPrinciples = () => {
  const tabs = [
    ...
    },
    {
      ...
      title: "Our Mission",
      content:
        "To deliver sustainable growth through innovation, operational excellence, and customer satisfaction.",
    },
    {
      id: 2,
      title: "Our Values",
      content:
        "Integrity, teamwork, and commitment to quality guide everything we do.",
    },
  ];
      ...
      <div className="hidden lg:flex flex-row items-stretch overflow-hidden relative">
        ...
        <div className="relative bg-white text-white lg:w-[40%] flex flex-col justify-center">
          <div className="relative flex gap-4">
            ...
            {/* Tabs */}
            <div className="space-y-6 w-full bg-gradient-orange-1 p-8 rounded-2xl relative">
              {tabs.map((tab, index) => (
        ...
        <div className="bg-[#F5F8FA] text-[#0D2B3E] flex-1 p-12 flex items-center rounded-r-2xl">
          <FadeInReveal>
            <SubH2>{tabs[active].content}</SubH2>
          </FadeInReveal>
        </div>
            ...
            >
              ...
              >
                <div className="p-5 text-[#0D2B3E]">
                  <BodyText1>{tab.content}</BodyText1>
                </div>
              </div>
            </div>
          );
