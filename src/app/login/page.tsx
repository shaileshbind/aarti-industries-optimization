        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full px-3 py-2 pr-16 rounded border border-[var(--grey-200)] bg-white text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--orange-200)] focus:border-transparent"
            />
            <button
              type="button"
              onClick={() => setShowPassword((prev) => !prev)}
              className="absolute right-2 top-1/2 -translate-y-1/2 text-[var(--grey-400)] hover:text-[var(--blue-200)] p-1"
